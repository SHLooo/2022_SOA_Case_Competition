...
TournDefense.data <- TournDefense[which(TournDefense$Pos != "GK"),defense.attributes]
```
...
TournPass.data <- TournPass[which(TournPass$Pos != "GK"),pass.attributes]
```
...
TournShoot.data <- TournShoot[which(TournShoot$Pos != "GK"), c(shoot.attributes, "nation rank")]
...
save(
  ...
  TournShoot.data,
  TournShoot.groupByPlayer,
  TournDefense.data,
  TournDefense.groupByPlayer,
  TournPass.data,
  TournPass.groupByPlayer,
  
  League.JoinedTable,
  Tourn.JoinedTable, 
  League.JoinedTable.Tailored, 
  Tourn.JoinedTable.Tailored, 
  Tourn.JoinedTable.ranked,

  file = "players_joined_subset.rda")
```
